...
namespace Analysim.Infrastructure.Infrastructure.Migrations
{
    ...
    [Migration("20260923172035_ConfigureProjectMemberPermissions")]
    partial class ConfigureProjectMemberPermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Project", b =>
                {
                    ...
                    b.Property<bool>("MembersCanEditProject")
                        .HasColumnType("boolean");

                    b.Property<bool>("MembersCanManageFiles")
                        .HasColumnType("boolean");

                    b.Property<bool>("MembersCanManageMembers")
                        .HasColumnType("boolean");

                    b.Property<bool>("MembersCanManageNotebooks")
                        .HasColumnType("boolean");

                    b.Property<bool>("MembersCanManageProjectLogs")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("MembersCanManagePublications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("MembersCanManageTags")
                        .HasColumnType("boolean");

                    b.Property<bool>("MembersCanUploadFiles")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("MembersCanUploadNotebooks")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Core.Entities.ProjectRecommendation", b =>
                {
                    b.Property<int>("ProjectRecommendationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProjectRecommendationID"));
                    ...
                    b.HasKey("ProjectRecommendationID");
            ...
            modelBuilder.Entity("Core.Entities.UserNotificationPreference", b =>
                {
                    b.Property<int>("UserID")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Notification", b =>
                {
                    b.HasOne("Core.Entities.User", "ActorUser")
                        .WithMany()
                    ...
                    b.HasOne("Core.Entities.User", "RecipientUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.ProjectRecommendation", b =>
                {
                    b.HasOne("Core.Entities.Project", "Project")
                        .WithMany("ProjectRecommendations")
                        .HasForeignKey("ProjectID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.Project", b =>
                {
                    ...
                    b.Navigation("ProjectRecommendations");
